...
export const CartItem = (props) => {
    ...
    return (
        <div className='CartItem'>
            <div className='flex'>
                <div className='border rounded-xl mx-auto grid grid-cols-1 sm:grid-cols-2 my-2'>
                    ...
                    <div className='sm:m-5 flex flex-col'>
                        <p className='text-2xl md:text-5xl sm:mt-1 md:mt-8 font-bold mx-auto sm:mx-0'>{product_name}</p>
                        <p className='text-xl md:text-4xl sm:mt-5 md:mt-10 mx-auto sm:mx-0'>₹{our_price}</p>
                        <p className='text-lg md:text-xl sm:mt-5 md:mt-10 font-semibold mx-auto sm:mx-0'>Quantity :-</p>
                        <div className='CountHandle w-1/3 my-1 sm:mt-1 md:mt-3 mx-auto sm:mx-0'>
