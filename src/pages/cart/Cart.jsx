...
export const Cart = () => {
  ...
  return (
    <div className=''>
      <div className='flex'>
        <h1 className='text-3xl mx-auto mt-[70px]'>Your Cart Items</h1>
      </div>
      <div className='cartItems grid grid-cols-1 xl:grid-cols-2 border mt-2'>
        {
      ...
      {TotalAmount > 0 ? (
        <div className='Checkout flex flex-col  p-2 mt-2 bg-white rounded-lg'>
          <p className='text-2xl text-center mt-3'>Total Cost: ₹{TotalAmount}</p>
          <div className='flex justify-center mt-5'>
            ...
            <button onClick={()=>navigate("/shipping")} className='border-2 hover:border-black mx-2 px-5 rounded-lg py-2 text-xl font-bold bg-black text-white hover:bg-white hover:text-black'>Buy Now</button>
          </div>
        </div>
      ) : (
